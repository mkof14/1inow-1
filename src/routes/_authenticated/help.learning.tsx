...
import { PageContainer, SectionHeader, SafeCard, ResponsiveGrid, Body, Label } from "@/components/layout";
  ...
  uk: {
    ...
    tracks: [
      ...
      { name: "Проєкти та виконання", lessons: [
        ...
        { title: "Задачі та узгодження", desc: "Канбан, маршрути узгоджень, аудит.", level: "Середній" },
      ]},
      { name: "Аналітика", lessons: [
        { title: "Звіти, що ведуть до рішень", desc: "Від сирих даних до рішення з джерелами.", level: "Просунутий" },
        { title: "Агенти та воркфлоу", desc: "Тимчасові агенти, ланцюги воркфлоу, людина у контурі.", level: "Просунутий" },
      ]},
    ],
  },
  es: {
  ...
  de: {
    ...
    tracks: [
      ...
      { name: "Projekte & Ausführung", lessons: [
        ...
        { title: "Aufgaben & Freigaben", desc: "Kanban, Freigabeketten, auditierbare Spur.", level: "Fortgeschritten" },
      ]},
      { name: "Intelligence", lessons: [
        { title: "Berichte, die entscheiden", desc: "Von Rohdaten zur Entscheidung mit Quellen.", level: "Profi" },
        { title: "Agenten & Workflows", desc: "Temporäre Agenten, verkettete Workflows, Human-in-the-Loop.", level: "Profi" },
      ]},
    ],
  },
};
              ...
              {tr.lessons.map((l) => (
                <SafeCard key={l.title}>
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="text-[10px] uppercase tracking-wider text-muted-foreground shrink-0">{l.level}</span>
                  </div>
