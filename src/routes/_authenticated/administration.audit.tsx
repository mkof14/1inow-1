...
function AuditPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <div>
        <h1 className="text-2xl font-semibold">{t("page.audit.title")}</h1>
        <p className="text-sm text-muted-foreground mt-1">{t("page.audit.subtitle")}</p>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <Select value={severity} onValueChange={setSeverity}>
          ...
          <SelectContent>
            ...
            <SelectItem value="warning">{t("page.audit.severity.warning")}</SelectItem>
            <SelectItem value="critical">{t("page.audit.severity.critical")}</SelectItem>
          </SelectContent>
        </Select>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-muted/30 text-xs uppercase tracking-wider text-muted-foreground">
              <tr>
                <th className="text-left px-4 py-2.5 font-medium">{t("tbl.time")}</th>
                <th className="text-left px-4 py-2.5 font-medium">{t("tbl.action")}</th>
                <th className="text-left px-4 py-2.5 font-medium">{t("tbl.module")}</th>
                <th className="text-left px-4 py-2.5 font-medium">{t("tbl.entity")}</th>
                <th className="text-left px-4 py-2.5 font-medium">{t("tbl.severity")}</th>
              </tr>
            </thead>
