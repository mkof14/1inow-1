...
const BUNDLES: Record<VoiceLocale, Bundle> = {
  en: {
    ...
    advice: {
      ...
      reminderDraft:
        "Without a time, the reminder goes to Voice Inbox. With a time, it becomes a live reminder.",
      reminderTime: "Include today, tomorrow, a date, or «in 30 minutes» for snooze-style timing.",
    ...
    evidence: {
      ...
      noteNotConnected: "Saves immediately to Voice Inbox",
      reminderPhrase: "Matched reminder phrase",
      reminderNotConnected: "Creates reminder or inbox draft depending on time",
      routeKeywords: "Matched route keywords",
      routeMap: "Source: local route map",
      noIntent: "No supported local intent matched",
      tryPhrases: "Try create task, show memory, snooze reminder, undo last, or batch with «then»",
    },
    toasts: {
  ...
  ru: {
    ...
    advice: {
      ...
      reminderDraft: "Без времени — в Voice Inbox. С временем — живое напоминание.",
      reminderTime: "Укажите сегодня, завтра, дату или «через 30 минут» для отложенного напоминания.",
    ...
    evidence: {
      ...
      noteNotConnected: "Сразу сохраняется в Voice Inbox",
      reminderPhrase: "Распознано напоминание",
      reminderNotConnected: "С временем — напоминание, без — черновик в inbox",
      ...
      tryPhrases: "Попробуйте: создай задачу, покажи память, отложи напоминание, отмени последнее",
    },
    toasts: {
  ...
  uk: {
    ...
    advice: {
      ...
      reminderDraft: "Без часу — у Voice Inbox. З часом — активне нагадування.",
      reminderTime: "Вкажіть сьогодні, завтра, дату або «через 30 хвилин».",
    ...
    evidence: {
      ...
      noteNotConnected: "Одразу зберігається в Voice Inbox",
      reminderPhrase: "Розпізнано нагадування",
      reminderNotConnected: "З часом — нагадування, без — чернетка в inbox",
      routeKeywords: "Розпізнано маршрут",
      routeMap: "Локальна карта маршрутів",
      noIntent: "Команду не розпізнано",
      tryPhrases: "Спробуйте: створи задачу, покажи пам'ять, відклади нагадування, скасуй останнє",
    },
    toasts: {
  ...
  es: {
    ...
    advice: {
      ...
      reminderDraft: "Sin hora — Voice Inbox. Con hora — recordatorio activo.",
      reminderTime: "Incluye hoy, mañana, fecha o «en 30 minutos».",
    ...
    evidence: {
      ...
      noteNotConnected: "Se guarda al instante en Voice Inbox",
      reminderPhrase: "Recordatorio reconocido",
      reminderNotConnected: "Con hora — recordatorio; sin hora — borrador en inbox",
      routeKeywords: "Ruta reconocida",
      routeMap: "Mapa local de rutas",
      noIntent: "Comando no reconocido",
      tryPhrases: "Prueba: crear tarea, mostrar memoria, posponer recordatorio, deshacer último",
    },
    toasts: {
  ...
  de: {
    ...
    advice: {
      ...
      reminderDraft: "Ohne Zeit — Voice Inbox. Mit Zeit — aktive Erinnerung.",
      reminderTime: "Heute, morgen, Datum oder «in 30 Minuten» angeben.",
    ...
    evidence: {
      ...
      noteNotConnected: "Wird sofort in Voice Inbox gespeichert",
      reminderPhrase: "Erinnerung erkannt",
      reminderNotConnected: "Mit Zeit — Erinnerung; ohne — Inbox-Entwurf",
      routeKeywords: "Route erkannt",
      routeMap: "Lokale Routenkarte",
      noIntent: "Befehl nicht erkannt",
      tryPhrases: "Versuche: Aufgabe erstellen, Gedächtnis zeigen, Erinnerung verschieben, rückgängig",
    },
    toasts: {
...
export const VOICE_ROUTES = [
  ...
  {
    route: "/reports",
    labels: { en: "Reports", ru: "Отчёты", uk: "Звіти", es: "Informes", de: "Berichte" },
    words: {
      en: ["reports", "report"],
      ru: ["отчёты", "отчет", "отчёт"],
      uk: ["звіти", "звіт"],
      es: ["informes", "informe"],
      de: ["berichte", "bericht"],
    },
  ...
  {
    route: "/approvals",
    labels: { en: "Approvals", ru: "Согласования", uk: "Погодження", es: "Aprobaciones", de: "Freigaben" },
    words: {
      en: ["approvals", "approval"],
      ru: ["согласования", "согласование", "approvals"],
      uk: ["погодження"],
      es: ["aprobaciones"],
      de: ["freigaben", "genehmigungen"],
    },
  },
  {
    route: "/communication",
    labels: { en: "Communication", ru: "Коммуникация", uk: "Комунікація", es: "Comunicación", de: "Kommunikation" },
    words: {
      en: ["communication", "messages", "channels", "chat"],
      ru: ["коммуникация", "сообщения", "каналы", "чат"],
      uk: ["комунікація", "повідомлення", "канали"],
      es: ["comunicación", "mensajes", "canales"],
      de: ["kommunikation", "nachrichten", "kanäle"],
    },
  },
  {
    route: "/intelligence",
    labels: { en: "Intelligence", ru: "Аналитика", uk: "Аналітика", es: "Inteligencia", de: "Analyse" },
    words: {
      en: ["intelligence", "memory", "analytics"],
      ru: ["аналитика", "intelligence", "память", "интеллект"],
      uk: ["аналітика", "пам'ять"],
      es: ["inteligencia", "memoria"],
      de: ["analyse", "intelligenz", "speicher"],
    },
  },
  {
    route: "/files",
    labels: { en: "Vault", ru: "Vault", uk: "Vault", es: "Vault", de: "Vault" },
    words: {
      en: ["files", "vault", "documents"],
      ru: ["файлы", "vault", "документы", "хранилище"],
      uk: ["файли", "vault", "документи", "сховище"],
      es: ["archivos", "vault", "documentos"],
      de: ["dateien", "vault", "dokumente"],
    },
  },
  {
    route: "/team-map",
    labels: { en: "Team Map", ru: "Карта команды", uk: "Карта команди", es: "Mapa del equipo", de: "Teamkarte" },
    words: {
      en: ["team map", "team-map", "map", "timezone"],
      ru: ["карта команды", "команда", "таймзоны", "часовые пояса"],
      uk: ["карта команди", "команда", "таймзони"],
      es: ["mapa del equipo", "equipo", "zonas horarias"],
      de: ["teamkarte", "team", "zeitzonen"],
    },
  },
] as const;
