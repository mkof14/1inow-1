...
export function MessageItem({
  ...
  return (
    <div
      className={cn(
        "group relative pl-4 pr-3 py-2 border-l-2 hover:bg-muted/30 transition-colors",
        meta.color,
      )}
    >
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    qc.invalidateQueries({
                      queryKey: ["messages", m.channel_id, m.thread_root_id],
                    });
                  }}
                >
                  Save
            ...
            <>
              ...
              <div className="mt-1">
                <TranslateButton
                  text={m.body}
                  sourceLang={
                    (m as unknown as { original_language?: string }).original_language ?? undefined
                  }
              ...
              {Object.entries(grouped).map(([emoji, count]) => (
                <button
                  ...
                  onClick={async () => {
                    ...
                    qc.invalidateQueries({ queryKey: ["reactions", m.channel_id] });
                  }}
