...
export function EmptyState({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-border surface-aurora shimmer-border ring-accent-soft fade-rise flex flex-col items-center justify-center text-center py-16 px-6">
